...
<div class="bg-gray-900 text-purple-lighter flex-none w-24 p-6 flex flex-col justify-between">
    ...
    @foreach ($channels as $channel)
        <a href="{{ route('channels.show', $channel['name']) }}">

            <div class="cursor-pointer mb-4">
                <div
                    class=" h-12 w-12 flex items-center justify-center text-black text-2xl font-semibold rounded-xl mb-1 overflow-hidden
                    {{
                        //CURRENT ROUTE WITH PARAMS

                        request()->route()->parameter('channel') == $channel['name'] ? 'bg-white' : 'bg-gray-800 text-white'
                    }}
                    ">
  ...
  <div>
    <a class="cursor-pointer" href="{{ route('settings') }}">
